import { E as Emitter, k as parse$1, m as getNodeType } from './polyfill.js';
import { E as ExtensionsRegistry, j as ExtensionMessageCollector, S as Sequencer, I as IExtensionService, o as IBrowserWorkbenchEnvironmentService, p as IHostColorSchemeService, q as IUserDataInitializationService } from './missing-services.js';
...
import { isUndefined, isString, isObject, isArray, isBoolean } from 'monaco-editor/esm/vs/base/common/types.js';
import { ColorScheme } from 'monaco-editor/esm/vs/platform/theme/common/theme.js';
import { IThemeService, getThemeTypeSelector, ThemeIcon, Extensions as Extensions$3 } from 'monaco-editor/esm/vs/platform/theme/common/themeService.js';
...
import { r as registerExtensionFile, g as getServiceOverride$1, a as getRemoteAuthority, I as IExtensionResourceLoaderService } from './files.js';
...
import { S as Services, i as IFileService } from './services2.js';
...
import { c as consoleExtensionMessageHandler } from './tools.js';
...
class ColorThemeData {
    ...
    getThemeSpecificColors(colors) {
        ...
        for (const key in colors) {
            ...
            if (this.isThemeScope(key) && scopedColors instanceof Object && !isArray(scopedColors)) {
                ...
                for (const themeScope of themeScopeList) {
                    ...
                    if (this.isThemeScopeMatch(themeId)) {
                        ...
                        for (const subkey in scopedThemeSpecificColors) {
                            ...
                            if (isArray(originalColors) && isArray(overrideColors)) {
...
const extensionPoint = ExtensionsRegistry.getExtensionPoints().find(ep => ep.name === 'themes');
let defaultThemes = [];
let themes = [];
...
function setThemes(_themes, getContent) {
...
function setDefaultThemes(_themes, getContent) {
...
export { getServiceOverride as default, setDefaultThemes, setThemes };

...
declare function setTokenTypes(tokenTypes: ITokenTypeExtensionPoint[], extension?: IExtensionDescription): void;
declare function setTokenModifiers(tokenModifiers: ITokenModifierExtensionPoint[], extension?: IExtensionDescription): void;
declare function setTokenStyleDefaults(tokenStyleDefaults: ITokenStyleDefaultExtensionPoint[], extension?: IExtensionDescription): void;
declare function getServiceOverride(): IEditorOverrideServices;

export { ITokenModifierExtensionPoint, ITokenStyleDefaultExtensionPoint, ITokenTypeExtensionPoint, getServiceOverride as default, setTokenModifiers, setTokenStyleDefaults, setTokenTypes };

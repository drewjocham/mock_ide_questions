 ...
 */
declare type ColorValue = Color | string | ColorIdentifier | ColorTransform;
...
declare type TypeConstraint = string | Function;

declare type ICommandsMap = Map<string, ICommand>;
...
declare type CollapseMemento = ILineMemento[];
...
declare class FoldingController extends Disposable implements IEditorContribution {
    ...
    private _maxFoldingRegions;
    private _notifyTooManyRegions;
    private _tooManyRegionsNotified;
...
declare type FileMatch = Partial<Record<string, string[]>>;

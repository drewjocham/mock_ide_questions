...
import { compareSubstring, isFalsyOrWhitespace, compare } from 'monaco-editor/esm/vs/base/common/strings.js';
...
import { r as registerExtensionFile, I as IExtensionResourceLoaderService } from './files.js';
...
function setSnippets(snippets, getContent, extension = Services.get().extension ?? DEFAULT_EXTENSION) {

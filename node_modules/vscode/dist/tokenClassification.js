...
const tokenTypeExtPoint$1 = ( ExtensionsRegistry.registerExtensionPoint({
...
const tokenModifierExtPoint$1 = ( ExtensionsRegistry.registerExtensionPoint({
...
const tokenStyleDefaultsExtPoint$1 = ( ExtensionsRegistry.registerExtensionPoint({
...
class TokenClassificationExtensionPoints {
    constructor() {
        ...
        tokenTypeExtPoint$1.setHandler((extensions, delta) => {
        ...
        tokenModifierExtPoint$1.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                const extensionValue = extension.value;
                const collector = extension.collector;
                if (!extensionValue || !Array.isArray(extensionValue)) {
        ...
        tokenStyleDefaultsExtPoint$1.setHandler((extensions, delta) => {
            for (const extension of delta.added) {
                const extensionValue = extension.value;
                const collector = extension.collector;
                if (!extensionValue || !Array.isArray(extensionValue)) {
...
const tokenTypeExtPoint = getExtensionPoint('semanticTokenTypes');
const tokenModifierExtPoint = getExtensionPoint('semanticTokenModifiers');
const tokenStyleDefaultsExtPoint = getExtensionPoint('semanticTokenScopes');
function setTokenTypes(tokenTypes, extension = Services.get().extension ?? DEFAULT_EXTENSION) {
...
function setTokenModifiers(tokenModifiers, extension = Services.get().extension ?? DEFAULT_EXTENSION) {
...
function setTokenStyleDefaults(tokenStyleDefaults, extension = Services.get().extension ?? DEFAULT_EXTENSION) {
...
export { getServiceOverride as default, setTokenModifiers, setTokenStyleDefaults, setTokenTypes };

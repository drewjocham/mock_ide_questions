...
declare function setKeybindings(grammars: ContributedKeyBinding | ContributedKeyBinding[], extension?: IExtensionDescription): void;
declare function setCommands(keybindings: IUserFriendlyCommand | IUserFriendlyCommand[], extension?: IExtensionDescription): void;
declare function updateUserKeybindings(keybindingsJson: string): void;
declare function getServiceOverride(): IEditorOverrideServices;

export { ContributedKeyBinding, IUserFriendlyKeybinding, getServiceOverride as default, setCommands, setKeybindings, updateUserKeybindings };

...
declare function setLanguages(language: Partial<IRawLanguageExtensionPoint>[], extension?: IExtensionDescription): void;
declare function getServiceOverride(): IEditorOverrideServices;

export { IRawLanguageExtensionPoint, getServiceOverride as default, setLanguages };

...
declare function setSnippets(snippets: ISnippetsExtensionPoint[], getContent: (snippet: ISnippetsExtensionPoint) => Promise<string>, extension?: IExtensionDescription): void;
declare function getServiceOverride(): IEditorOverrideServices;

export { ISnippetsExtensionPoint, getServiceOverride as default, setSnippets };

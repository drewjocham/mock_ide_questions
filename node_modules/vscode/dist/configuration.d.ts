...
declare type PolicyName = string;
...
declare type IRegisteredConfigurationPropertySchema = IConfigurationPropertySchema & {
    defaultDefaultValue?: any;
    source?: IExtensionInfo;
    defaultValueSource?: IExtensionInfo | string;
};
declare type IConfigurationDefaultOverride = {
    readonly value: any;
...
declare function updateUserConfiguration(configurationJson: string): void;
declare const configurationRegistry: IConfigurationRegistry;
declare function getServiceOverride(): IEditorOverrideServices;

export { ConfigurationScope, IColorCustomizations, IConfigurationDefaults, IConfigurationNode, IThemeScopedColorCustomizations, configurationRegistry, getServiceOverride as default, updateUserConfiguration };

...
import { IndentAction } from 'monaco-editor/esm/vs/editor/common/languages/languageConfiguration.js';
                ...
                properties: {
                    beforeText: {
                        ...
                        properties: {
                            ...
                            flags: {
                                type: 'string',
                                description: ( localize('schema.onEnterRules.beforeText.flags', 'The RegExp flags for beforeText.')),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: ( localize(
                    ...
                    afterText: {
                        ...
                        properties: {
                            ...
                            flags: {
                                type: 'string',
                                description: ( localize('schema.onEnterRules.afterText.flags', 'The RegExp flags for afterText.')),
                                default: '',
                                pattern: '^([gimuy]+)$',
                                patternErrorMessage: ( localize(
                    ...
                    action: {
                        type: ['string', 'object'],
                        description: ( localize('schema.onEnterRules.action', 'The action to execute.')),
                        required: ['indent'],
...
function setLanguageConfiguration(path, getConfiguration) {
...
export { getServiceOverride as default, setLanguageConfiguration };
